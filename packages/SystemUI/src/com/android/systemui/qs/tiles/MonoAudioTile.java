...
public class MonoAudioTile extends QSTileImpl<BooleanState> {
    ...
    @Inject
    public MonoAudioTile(QSHost host) {
        super(host);
    ...
    public CharSequence getTileLabel() {
        return mContext.getString(R.string.quick_settings_mono_audio_label);
    }
    ...
    protected String composeChangeAnnouncement() {
        if (mState.value) {
            return mContext.getString(
                    R.string.accessibility_quick_settings_mono_audio_changed_on);
        } else {
            return mContext.getString(
                    R.string.accessibility_quick_settings_mono_audio_changed_off);
        }
    }
}
